        ...
        try:
            ...
            if config_str:
                ...
                if config.get("drop_requests"):
                    return JSONResponse(status_code=500, content={"detail": "Request dropped by failure injection"})
                ...
                if random.random() < config.get("error_rate", 0):
                    return JSONResponse(status_code=500, content={"detail": "Internal Server Error (Injected)"})
        except Exception:
            pass
